...
\section{In-person Recruitment Script}
  \setting{
    Potential participants will be found in public places, and so an opening in French will be used to establish that they speak French, at which point the script will begin.
  }

  Mon nom c'est Josh McNeill, et je suis chercheur de linguistique.
